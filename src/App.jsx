...
const features = [
  ...
  },
  {
    ...
    description: 'Inline all CSS and JS in a single minified file.',
  },
];
      ...
      <div className='relative bg-white px-4 py-10 shadow-lg sm:rounded-3xl sm:p-20'>
        <div className='mx-auto max-w-md'>
          ...
          <div className='divide-y divide-gray-200'>
            <div className='space-y-5 py-8 text-base leading-6 text-gray-900 sm:text-lg sm:leading-7'>
              <h1 className='text-lg font-semibold text-cyan-600'>
                Sale's Project First React App
              </h1>
              <p>Sale's Project First React App Mealzo.</p>

...
import CaseDetails from './components/CaseDetails'; // Updated import: ShopDetailsPage to CaseDetails
...
            {/* Updated route: /shop/:id changed to /case/:id, and component changed to CaseDetails */}

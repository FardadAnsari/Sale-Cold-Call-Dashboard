  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <span className="font-medium">
              {postcodesForSelectedCity.length}
            </span>{' '}
            postcode{postcodesForSelectedCity.length !== 1 ? 's' : ''} available in{' '}
            {filters.city}
          </p>
        </div>
      )}
      ...
      <div className="flex justify-between pt-4">
        ...
        <button
          onClick={onApply}
          className="px-4 py-2 rounded-md text-sm font-medium bg-orange-500 hover:bg-orange-600 text-white transition-colors"
        >
          Apply
        </button>
      </div>
